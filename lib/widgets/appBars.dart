...
Widget emptyAppbar([String title]) {
  return PreferredSize(
    ...
    child: GradientAppBar(
      ...
      title: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            AutoSizeText(
              (title != null)?title:'Maa Durga Jewellers sdsssddsd',
      ...
      gradient: LinearGradient(
        ...
        colors: [CustomColors.PurpleDark, CustomColors.HeaderBlueLight],
      ),
    ),
  );
}
...
class CircleOne extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    canvas.drawCircle(Offset(40.0, 5.0), 70.0, _paint);
  }
...
class CircleThree extends CustomPainter {
  Paint _paint;
  ...
  @override
  void paint(Canvas canvas, Size size) {
    canvas.drawCircle(Offset(0, 50), 40.0, _paint);
  }
